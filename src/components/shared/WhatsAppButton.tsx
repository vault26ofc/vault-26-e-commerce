export default function WhatsAppButton({ number = '919999999999' }: { number?: string }) {
  const msg = encodeURIComponent('Hi Vault 26! I need help with...');
  return (
    <a href={`https://wa.me/${number}?text=${msg}`} target="_blank" rel="noopener noreferrer"
      className="fixed bottom-20 lg:bottom-6 right-5 z-30 h-12 w-12 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center text-white hover:scale-105 btn-press"
      aria-label="WhatsApp">
